...
### Макрос 1: Создание учетных записей студентов (`Macro (1).cs`)
...
### Макрос 2: Распределение заданий (`Macro (2).cs`)
...
└── Студенты/
    └── ИВТ-101/      ← группа
        ├── Иванов П.С./   ← папка студента (формат "Фамилия И.О.")
        ├── Петрова А.И./
        └── ...
```

**Важные правила:**
- Название папки группы должно совпадать с названием файла/группы пользователей
- Папки студентов должны быть в формате "Фамилия И.О."
- В папках "Работа N" должны быть файлы вариантов в форматах `.grb`, `.pdf`, `.tif`, `.tiff`
